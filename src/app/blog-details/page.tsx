              ...
              <div>
                    ...
                    <div className="mr-10 mb-5 flex items-center">
                      <div className="mr-4">
                        <div className="relative h-10 w-10 overflow-hidden rounded-full">
                          <Image src="/images/logo/logo.svg" alt="Future Designz" fill />
                        </div>
                      </div>
                      <div className="w-full">
                        <span className="text-body-color mb-1 text-base font-medium">
                          By <span>Future Designz</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Choosing the right tiles is essential for both form and function. Premium ceramic and porcelain tiles not only elevate aesthetics but also improve durability and ease of maintenance. Our curated collections are chosen for lasting performance and refined design.
                    <strong className="text-primary dark:text-white">
                      Quality craftsmanship
                    </strong>
                    combined with thoughtful design transforms ordinary bathrooms into luxurious retreats. Our expert team provides personalized guidance to help you select products that reflect your style and meet your practical needs.
                  </p>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  ...
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                      "Future Designz transformed my bathroom with stunning Italian tiles and premium fixtures. The attention to detail and customer service was exceptional. Highly recommended for anyone looking to elevate their space!"
                    </p>
