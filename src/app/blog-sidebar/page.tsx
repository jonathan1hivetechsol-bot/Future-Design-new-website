              ...
              <div>
                ...
                <div>
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Choosing premium bathroom tiles requires careful consideration of both style and functionality. Modern tile selection goes beyond aesthetics—durability, water resistance, and ease of maintenance are equally important. Our expert team at Future Designz understands these nuances and helps customers make informed decisions. We partner with <strong className="text-primary dark:text-white">
                      {" "}
                  ...
                  <div className="bg-primary/10 relative z-10 mb-10 overflow-hidden rounded-md p-8 md:p-9 lg:p-8 xl:p-9">
                    <p className="text-body-color text-center text-base font-medium italic">
                      "Working with Future Designz was a game-changer. Their extensive product range and expert guidance helped us select perfect tiles that transformed our space. Absolutely worth the investment!"
                    </p>
