...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  ...
  return (
    <>
      <div className="group shadow-one hover:shadow-two dark:bg-dark dark:hover:shadow-gray-dark relative overflow-hidden rounded-xs bg-white duration-300 h-full flex flex-col">
        <Link
