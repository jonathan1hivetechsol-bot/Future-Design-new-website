...
const Footer = () => {
  ...
  return (
    <>
      <footer 
        ref={ref}
        className={`relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24 transition-all duration-700 ${
        ...
        <div className="container">
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 lg:mb-16 max-w-full lg:max-w-[360px]">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <a
                    href="https://twitter.com/futuredesignz"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                  ...
                  <a
                    href="https://pk.linkedin.com/company/future-designz"
                    aria-label="social-link"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  ...
                  <li className="mb-4">
                    <a
                      href="mailto:info@futuredesignz.pk"
                      className="text-base text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary"
                    >
                      info@futuredesignz.pk
                    </a>
                  </li>
                  <li>
                    <p className="text-base text-body-color dark:text-body-color-dark">
                      150 CCA Phase 4 DHA<br />
                      Lahore, Pakistan
                    </p>
                  </li>
                </ul>
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Copyright © 2024 Future Designz. All Rights Reserved.
            </p>
          </div>
        </div>
