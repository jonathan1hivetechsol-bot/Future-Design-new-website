...
const testimonialData: Testimonial[] = [
  {
    ...
    content:
      "Future Designz helped me transform my bathroom with beautiful imported tiles. The quality is exceptional and the team's guidance was invaluable. Highly recommended!",
...
const Testimonials = () => {
  ...
  return (
    <section 
      ref={ref}
      className={`dark:bg-bg-color-dark bg-gray-light relative z-10 py-16 md:py-20 lg:py-28 transition-all duration-700 ${
    ...
    >
      <div className="container">
        <SectionTitle
          ...
          paragraph="Hear from homeowners and professionals who have transformed their spaces with Future Designz premium tiles and bathroom fixtures."
          center
        />
